  ...
  <div style="display: flex; flex-direction: column; height: calc(100vh - 165px)">
    ...
    <el-form label-width="80px" label-position="right" size="mini">
      <el-form-item label="行政区">
        <el-select clearable v-model="checkboxList" style="width: 100%"> </el-select>
      </el-form-item>
      ...
      <el-form-item label="站点名称">
        <el-input v-model="query.keyword" placeholder="请输入积涝点名称"></el-input>
      </el-form-item>
      <el-form-item label="积水预报">
        <!-- <el-button type="primary">0.5小时</el-button> -->
        <el-button type="primary">1小时</el-button>
        <el-button type="primary">3小时</el-button>
      </el-form-item>
    ...
    <ZebraTitle>
      <span
        style="
          ...
          color: rgba(60, 83, 104, 1);
        "
        >水情信息列表(共{{ data.length - 1 }}条记录，1个测站掉线)</span
      >
    </ZebraTitle>
    <div
